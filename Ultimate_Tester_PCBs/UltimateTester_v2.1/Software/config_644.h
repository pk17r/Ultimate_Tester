...
#define TP_BAT           PA6       /* test pin for battery (4:1 voltage divider) */
...
#define R_RL_1           PD1       /* Rl (680R) for test pin #1 */
...
#define POWER_CTRL       PC5       /* control pin (1: on / 0: off) */
...
#define BUZZER_CTRL      PD2       /* control pin (low: off / high: on) */
