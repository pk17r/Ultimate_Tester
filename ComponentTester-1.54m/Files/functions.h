 ...
 * ************************************************************************ */
  ...
  extern void CheckPowerSupply(void);
  #endif
...
extern void MP28167_A_Get_ILim_InRange(uint16_t Vin_mV, uint16_t Vout_mV);
...
extern void MP28167_A_inc_dec_Vout(uint16_t steps, int8_t direction);
extern uint16_t MP28167_A_getILimMax_mA(uint16_t Vin_mV, uint16_t Vout_mV);
extern uint16_t MP28167_A_getILimMin_mA();
extern void MP28167_A_change_ILim(uint16_t steps, int8_t direction);
