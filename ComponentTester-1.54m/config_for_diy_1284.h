...
//  #define I2C_RW                                             /* Requires I2C Read Support  */
  #define INA226_I2C_ADDR                          0x40      /* 0x40 is address when A0=GND, A1=GND. For other address options, lookup "Table 6-2. Address Pins and Slave Addresses" in INA226 Datasheet  */
  #define INA226_R_SHUNT_MILLI_OHM                 21.32     /* Shunt Resistance in Milli Ohms, can be a float. Recommended shunt resistor resistance is of 20mOhms for 0-3A range, 10mOhms for 0-6A range, 2mOhms for 0-10A range  */
  ...
  #define INA226_AVERAGING_SAMPLES                 0         /* Number of samples per measurement. Range of values 0-7 provides for 1-1024 samples per measurement */
  #define INA226_I_OFFSET_MICRO_AMP                -200      /* Offset current in microamps on shunt at no load that is added to measurement to make it zero. Can be negative */
  #define INA226_BUS_V_MULTIPLIER_e4               10013     /* Bus Voltage Manual Calibration Multiplier to increase accuracy in measurements. Only whole numbers accepted */
  #define INA226_P_THRESHOLD_mW_BUZZER             2500      /* Over-Power Alert Beeps: Sound buzzer if power goes over this threshold. HW_BUZZER needs to be enabled for this feature. Single Tap to disable/enable beeps. */
  #define I2C_RW                                             /* Requires I2C Read Support  */
...
#define INA3221_POWER_MONITOR
  ...
  #define INA3221_CH1_R_SHUNT_MILLI_OHM             39.427        /* Shunt Resistance in Milli Ohms, can be a float. Recommended shunt resistor resistance is of 20mOhms for 0-3A range, 10mOhms for 0-6A range, 2mOhms for 0-10A range  */
  #define INA3221_CH2_R_SHUNT_MILLI_OHM             39.957        /* Shunt Resistance in Milli Ohms, can be a float. Recommended shunt resistor resistance is of 20mOhms for 0-3A range, 10mOhms for 0-6A range, 2mOhms for 0-10A range  */
  #define INA3221_CH3_R_SHUNT_MILLI_OHM             39.586        /* Shunt Resistance in Milli Ohms, can be a float. Recommended shunt resistor resistance is of 20mOhms for 0-3A range, 10mOhms for 0-6A range, 2mOhms for 0-10A range  */
...
#elif defined (__AVR_ATmega324P__) || defined (__AVR_ATmega644__) || defined (__AVR_ATmega1284P__)
